...
│   └── project.html    # Projeler sayfası
└── assets/
    ├── css/
    │   └── style.css   # Ana stil dosyası
    ├── img/            # Resimler ve medya dosyaları
    └── js/
...
✨ **Vanilla JavaScript (ES6+)**: Etkileşimli özellikler ve animasyonlar.
✨ **Google Fonts**: Playfair Display ve JetBrains Mono fontları.

 ## Kurulum

Projeyi yerel makinenizde çalıştırmak için herhangi bir özel kurulum gerekmez.
...
👉 https://web-projesi-2026.github.io/web_portfolio_naciyeduygu/

## İletişim
Naciye Duygu
⭐ 📧 E-posta: [duygu.naciye@ogr.ahievran.edu.tr](mailto:duygu.naciye@ogr.ahievran.edu.tr)
⭐ 💼 LinkedIn: https://www.linkedin.com/in/naciye-duygu-4a7bb634b?
⭐ 💻 GitHub: https://github.com/naciyeduygu
